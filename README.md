...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/openfort-xyz/recovery-endpoint-vercel&project-name=shield-recovery-endpoint&env=SHIELD_PUBLISHABLE_KEY,SHIELD_SECRET_KEY,SHIELD_ENCRYPTION_KEY&envDescription=Required%20Shield%20API%20keys%20from%20your%20Openfort%20project&envLink=https://www.openfort.xyz/docs&project-deployment-protection=disabled)
